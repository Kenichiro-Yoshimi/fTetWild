...
namespace floatTetWild {
    ...
    void collapsing(std::vector<Vector3>& input_vertices, std::vector<Vector3i>& input_faces, const AABBWrapper& sf_tree, const Parameters& params,
                    std::vector<uint8_t>& is_v_removed, std::vector<uint8_t>& is_f_removed, std::vector<std::unordered_set<int>>& conn_fs);
    ...
    void check_surface(std::vector<Vector3>& input_vertices, std::vector<Vector3i>& input_faces, const std::vector<uint8_t>& is_f_removed,
