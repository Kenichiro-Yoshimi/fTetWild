...
// #endif
        ...
        static void one_ring_edge_set(const std::vector<std::array<int, 2>> &edges, const std::vector<uint8_t> &v_is_removed,
                          const std::vector<uint8_t> &f_is_removed, const std::vector<std::unordered_set<int>> &conn_fs,
